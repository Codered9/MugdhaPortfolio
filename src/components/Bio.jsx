...
function Bio() {
    ...
    return (
        <>
        <div ref={bioRef} id="Bio" className="h-screen sticky top-0 text-4xl font-syne font-semibold flex items-center justify-center snap-start z-0">
            <div className="max-w-6xl mx-auto my-auto text-left">
